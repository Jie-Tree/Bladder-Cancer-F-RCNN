...
model_path = 'model/' + str(otherStyleTime) + 'grad_model_frcnn.hdf5'
config_path = 'model/' + str(otherStyleTime) + 'grad_config.pickle'

C.model_path = model_path
C.num_rois = 32

all_imgs, classes_count, class_mapping = get_data('managedata/grad_data_with_person.txt')
