...
config_output_filename = '/home/tree/FasterRcnn-keras/Grad-FasterRcnn/model/2019-04-09 11:35:37grad_config.pickle'
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
	...
	# cv2.waitKey(0)
	cv2.imwrite('./result/{}.png'.format(idx), img_scaled)
	print(all_dets)
